...
const ProjectCard = (props) => {
    return (
        <div className="w-full sm:w-1/2 lg:w-4/12 px-4 mb-4 mx-0 ">
            <div className={`w-full bgImage shadow-[0_3px_15px_rgba(0,0,0,0.15)] ${props.shadowColor} bg-[#04071D] border border-[#1E2034] rounded-lg shadow-lg p-6 flex flex-col justify-center items-center relative overflow-hidden`}>
